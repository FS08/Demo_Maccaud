...
Auteur : OM 2023.03.20
Nécessite un fichier de configuration externe : ".env"
Nécessite un fichier DUMP en MySql de la BD : /database/MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023.sql
"""
import os
import re
...
class ToolsBd:
    ...
    def extract_name_bd_from_dump_file():
        ...
        But : Extrait la chaîne de caractère du nom de la base de donnée contenu dans le fichier :
                    "MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023.sql"
    ...
    def test_cmd_CRD_file_dump_sql():
        ...
        Tester si il y a des problèmes éventuels sur le fichier : "MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023.sql"
        ...
        try:
            if os.path.exists(NAME_FILE_DUMP_SQL_BD):
                fichier_dump_sql_bd = open(NAME_FILE_DUMP_SQL_BD, "r", encoding="utf8")
                lignes_fichier_dump = fichier_dump_sql_bd.read()
                """Si le fichier DUMP en SQL "../database/MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023.sql" existe, 
