...
-- DE REQUETES MYSQL
-- Database: MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023

-- Détection si une autre base de donnée du même nom existe

DROP DATABASE IF EXISTS MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023;

-- Création d'un nouvelle base de donnée

CREATE DATABASE IF NOT EXISTS MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023;

-- Utilisation de cette base de donnée

USE MACCAUD_OLIVIER_INFO1X_EXERCICES_164_2023;
-- --------------------------------------------------------
...
(19, 'Les classes des INFOS de 1ère année sont vraiment extraordinaires', NULL, 'film fantasque', NULL, NULL);
